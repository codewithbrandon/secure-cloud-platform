...
Write-Host "Importing mgmt subnet NSG association..."
& $terraformPath import "module.networking.azurerm_subnet_network_security_group_association.mgmt" "/subscriptions/1802a8b6-7c48-4e43-b8d7-0ea4369ac707/resourceGroups/rg-seccloud-prod/providers/Microsoft.Network/virtualNetworks/vnet-seccloud-prod/subnets/snet-mgmt-seccloud-prod"
